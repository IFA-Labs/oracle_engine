        ...
        "/prices/audit": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "End date in RFC3339 format (e.g., 2024-01-02T00:00:00Z)",
                        "name": "to",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Asset ID to filter by (optional)",
                        "name": "asset",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        "models.APIKey": {
            ...
            "properties": {
                ...
                "key": {
                    "description": "Only show on creation",
                    "type": "string"
                },
                "last_used": {
                    "type": "string"
                ...
                "subscription_plan": {
                    "description": "Added for rate limiting context",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.CompanyProfile": {
            ...
            "properties": {
                ...
                "subscription_plan": {
                    "description": "\"free\", \"developer\", \"professional\", \"enterprise\"",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
